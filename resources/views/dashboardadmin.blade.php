...
<head>
    ...
    <link href="{{ asset('/templete/vendor/vector-map/jqvmap.min.css')}}" rel="stylesheet" media="all">
...
<body class="animsition">
            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    <div class="image img-cir img-120">
                        <img src="templete/images/icon/avatar-big-01.jpg" alt="Admin" />
                    </div>
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="table.html">
                                <i class="fas fa-table"></i>Pending User</a>
                        </li>
                        <li>
                            <a href="table.html">
                                <i class="fas fa-users"></i>Group Chat</a>
                        </li>
        ...
        <div class="page-container2">
            ...
            <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
                ...
                <div class="menu-sidebar2__content js-scrollbar2">
                    <div class="account2">
                        <div class="image img-cir img-120">
                            <img src="images/icon/avatar-big-01.jpg" alt=" Yusuf Islam" />
                        </div>
                        <h4 class="name">Yusuf Islam</h4>
                        <a href="#">Sign out</a>
                    </div>
                    <nav class="navbar-sidebar2">
                        <ul class="list-unstyled navbar__list">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item statistic__item--orange">
                                    ...
                                    <span class="desc">Pending User</span>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item statistic__item--blue">
                                    ...
                                    <span class="desc">Group Chat</span>
                                    <div class="icon">
            ...
            <section>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright © 2021 Muslim Go Online. All rights reserved. Template by <a href="https://muslimgoonline.com">Muslim Go Online</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{ asset('/templete/vendor/vector-map/jquery.vmap.js')}}"></script>
    <script src="{{ asset('/templete/vendor/vector-map/jquery.vmap.min.js')}}"></script>
    <script src="{{ asset('/templete/vendor/vector-map/jquery.vmap.sampledata.js')}}"></script>
    <script src="{{ asset('/templete/vendor/vector-map/jquery.vmap.world.js')}}"></script>
